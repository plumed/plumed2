...
la: LOCAL_AVERAGE ARG=d1 SWITCH={RATIONAL D_0=1.3 R_0=0.2} MORE_THAN={RATIONAL R_0=4} 
...
void LocalAverage::registerKeywords( Keywords& keys ) {
  ...
  keys.setValueDescription("vector","the values of the local averages"); keys.addDOI("10.1063/1.2977970");
}
