...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_adjmat_OldAdjacencyMatrixBase_h
#define __PLUMED_adjmat_OldAdjacencyMatrixBase_h
...
class OldAdjacencyMatrixBase : public multicolvar::MultiColvarBase {
...
public:
  ...
  explicit OldAdjacencyMatrixBase(const ActionOptions&);
...
inline
AdjacencyMatrixVessel* OldAdjacencyMatrixBase::getAdjacencyVessel() {
  return mat;
}

inline
unsigned OldAdjacencyMatrixBase::getBaseColvarNumber( const unsigned& inum ) const {
  if( atom_lab[inum].first>0 ) return atom_lab[inum].first-1;
  return 0;
}

inline
AtomNumber OldAdjacencyMatrixBase::getAbsoluteIndexOfCentralAtom( const unsigned& iatom ) const {
