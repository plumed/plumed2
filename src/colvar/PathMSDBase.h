...
/// this class is a general container for path stuff
  ...
  bool computeRefClose; //flag indicating necessity to recompute accurately all distances and rotation matrices between the close structure and reference structures
