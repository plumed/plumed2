...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_gridtools_OldActionWithGrid_h
#define __PLUMED_gridtools_OldActionWithGrid_h
...
class OldActionWithGrid : public vesselbase::ActionWithAveraging {
private:
...
public:
  ...
  explicit OldActionWithGrid( const ActionOptions& );
