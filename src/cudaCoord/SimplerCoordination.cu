...
class SimplerCudaCoordination : public Colvar {
...
public:
  explicit SimplerCudaCoordination(const ActionOptions &);
...
using SCudaCoordination_f = SimplerCudaCoordination<float>;
PLUMED_REGISTER_ACTION(SCudaCoordination_d, "SIMPLECUDACOORDINATION")
PLUMED_REGISTER_ACTION(SCudaCoordination_f, "SIMPLECUDACOORDINATIONFLOAT")

template <typename calculateFloat>
void SimplerCudaCoordination<calculateFloat>::setUpPermanentGPUMemory() {
...
template <typename calculateFloat>
void SimplerCudaCoordination<calculateFloat>::calculate() {
