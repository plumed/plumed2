...
/// Set a pointer to an extra CV.
  virtual void setExtraCV(const std::string &name,TypesafePtr p)=0;
/// Set a pointer to an extra CV force.
  virtual void setExtraCVForce(const std::string &name,TypesafePtr p)=0;
