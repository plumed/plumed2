...
useful however to use this tool as a quick aid memoir.  For example, if you want to understand the documentation
for the DISTANCE command you can generate its template by using the following command
