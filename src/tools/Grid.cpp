...
// And read the stuff from the header
  ...
  if(!dosparse) {grid=std::make_unique<Grid>(funcl,args,gmin,gmax,gbin,dospline,doder);}
  else {grid=std::make_unique<SparseGrid>(funcl,args,gmin,gmax,gbin,dospline,doder);}
