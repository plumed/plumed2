...
/// Same as `for(unsigned i=0;i<n;i++) d[i]+=v[i];`
  template<typename T>
  static constexpr void _add(T*d,const T*v) noexcept;
/// Subtract v from d.
/// Same as `for(unsigned i=0;i<n;i++) d[i]-=v[i];`
  template<typename T>
  static constexpr void _sub(T*d,const T*v) noexcept;
/// Multiply d by s.
/// Same as `for(unsigned i=0;i<n;i++) d[i]*=s;`
  template<typename T>
  static constexpr void _mul(T*d,const T s) noexcept;
/// Set d to -v.
/// Same as `for(unsigned i=0;i<n;i++) d[i]=-v[i];`
  template<typename T>
  static constexpr void _neg(T*d,const T*v) noexcept;
/// Squared modulo of d;
/// Same as `r=0.0; for(unsigned i=0;i<n;i++) r+=d[i]*d[i]; return r;`
  template<typename T>
  static constexpr T _sum2(const T*d) noexcept;
/// Dot product of d and v
/// Same as `r=0.0; for(unsigned i=0;i<n;i++) r+=d[i]*v[i]; return r;`
  template<typename T>
  static constexpr T _dot(const T*d,const T*v) noexcept;
};
...
template<unsigned n>
template<typename T>
constexpr void LoopUnroller<n>::_add(T*d,const T*a) noexcept {
  if constexpr (n>1) {
...
template<unsigned n>
template<typename T>
constexpr void LoopUnroller<n>::_sub(T*d,const T*a) noexcept {
  if constexpr (n>1) {
...
template<unsigned n>
template<typename T>
constexpr void LoopUnroller<n>::_mul(T*d,const T s) noexcept {
  if constexpr (n>1) {
...
template<unsigned n>
template<typename T>
constexpr void LoopUnroller<n>::_neg(T*d,const T*a ) noexcept {
  if constexpr (n>1) {
...
template<unsigned n>
template<typename T>
constexpr T LoopUnroller<n>::_sum2(const T*d) noexcept {
  if constexpr (n>1) {
...
template<unsigned n>
template<typename T>
constexpr T LoopUnroller<n>::_dot(const T*d,const T*v) noexcept {
  if constexpr (n>1) {
