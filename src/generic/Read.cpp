        ...
        if( name=="*" ) {
            ...
            for(unsigned i=0; i<fieldnames.size(); ++i) {
                if( fieldnames[i].substr(0,dot)==label ) {
                    readvals.emplace_back(new Value(this, fieldnames[i], false) );
            ...
            readvals.emplace_back(new Value(this, valread[0], false) );
            ...
            for(unsigned i=1; i<valread.size(); ++i) {
                ...
                readvals.emplace_back(new Value(this, valread[i], false) );
