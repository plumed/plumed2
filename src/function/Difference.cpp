...
class Difference : public FunctionTemplateBase {
private:
  bool periodic;
...
typedef FunctionShortcut<Difference> DifferenceShortcut;
PLUMED_REGISTER_ACTION(DifferenceShortcut,"DIFFERENCE")
typedef FunctionOfScalar<Difference> ScalarDifference;
PLUMED_REGISTER_ACTION(ScalarDifference,"DIFFERENCE_SCALAR")
typedef FunctionOfVector<Difference> VectorDifference;
