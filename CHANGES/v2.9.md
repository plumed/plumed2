...
- New in ISDB module:
  - the \ref SAXS CV now includes a more efficient and more accurate hybrid SAXS algorithm that can be activated using the keyword `ONEBEAD`.
  - a new \ref SANS CV to calculate small-angle neutron scattering has been added.
