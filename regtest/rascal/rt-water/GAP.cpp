  ...
  ActionShortcut(ao)
{
  ...
  readInputLine( getShortcutLabel() + "_weights: CONSTANT VALUES=" + myvec );
  // Now get the values
  ...
  readInputLine( getShortcutLabel() + "_matrix: CONSTANT FILE=" + getShortcutLabel() + "_matrixfile" );
  ...
  readInputLine( getShortcutLabel() + "_prod: MATRIX_PRODUCT ARG=" + getShortcutLabel() + "_soap," + getShortcutLabel() + "_matrix" ); 
  // And the vector matrix times the vector
  readInputLine( getShortcutLabel() + "_vprod: MATRIX_VECTOR_PRODUCT ARG=" + getShortcutLabel() + "_prod," + getShortcutLabel() + "_weights");
